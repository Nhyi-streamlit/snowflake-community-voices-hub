...
with col_spk:
    ...
    <div style="background:linear-gradient(135deg,#EBF8FF,#BEE3F8);border:2px solid #29B5E8;
                border-radius:16px;padding:28px 22px;text-align:center;height:260px;">
      <div style="font-size:2rem;margin-bottom:10px;">🎤</div>
      <h3 style="color:#1A365D;font-size:1.2rem;margin-bottom:8px;">Speaker Portal</h3>
      <p style="color:#2D4A6B;font-size:0.88rem;">Browse events, book travel, access resources, and get Uber gift cards.</p>
    </div>
    """, unsafe_allow_html=True)
